        ...
        <div class="card">
          <div class="card-body">
            <div class="justify-content-center">
              <div class="">
                <p class="fw-bolder fs-5 text-center green mb-0">
                  Upload Image
                </p>
                ...
                <div class="my-5 container ">
                  <div class="input-group py-2 d-none ">
                    <input type="file" class="form-control form-control-3" id="inputGroupFile02" />
                    <label class="input-group-text form-control-3 text-danger fw-bold"
                      style="cursor: pointer">Upload</label>
                  </div>
                
                    <div class="form-control-iz  px-2  ">
                    <div class="d-flex align-items-center justify-content-between h-100 ">
                      <button @click="getFile()" class="btn btn-white btn-iz py-0   mb-0 fw-bold ">
                        <i class="fas fa-file-image fs-5"></i> &nbsp; Add files from my
                        computer
                      </button>


                      <label class="border_right_iz text-danger fw-bold h-100 d-flex align-items-center px-3"
                        style="cursor: pointer">Upload</label>
                    </div>
                  </div>
